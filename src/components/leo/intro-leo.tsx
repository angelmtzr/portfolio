  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">Digital Animation Engineering</span>{" "}
        student. I like{" "}
        <span className="italic">
          art in general, videogames, and technology
        </span>
        . My focus is <span className="underline">Artistic Animation</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/leonardo-lópez-raygoza-66a235277/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/LeonardoRyz"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
