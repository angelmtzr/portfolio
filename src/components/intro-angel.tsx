...
export default function Intro() {
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Angel.</span> I'm a{" "}
        <span className="font-bold">
          Computer Graphics and Systems Engineering
        </span>{" "}
        student. I enjoy building{" "}
        <span className="italic">web apps, computer systems, and more</span>. My
        focus is <span className="underline">Web Development</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://linkedin.com/in/angelmtzr"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/angelmtzr"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
